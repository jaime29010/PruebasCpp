...
void ::Pruebas5::App::InitializeComponent()
{
#if defined _DEBUG && !defined DISABLE_XAML_GENERATED_BREAK_ON_UNHANDLED_EXCEPTION
...
::Windows::UI::Xaml::Markup::IXamlType^ ::Pruebas5::App::GetXamlType(::Windows::UI::Xaml::Interop::TypeName type)
{
...
::Windows::UI::Xaml::Markup::IXamlType^ ::Pruebas5::App::GetXamlType(::Platform::String^ fullName)
{
    if(_provider == nullptr)
    {
        _provider = ref new XamlTypeInfo::InfoProvider::XamlTypeInfoProvider();
...
::Platform::Array<::Windows::UI::Xaml::Markup::XmlnsDefinition>^ ::Pruebas5::App::GetXmlnsDefinitions()
{
